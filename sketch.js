...
opponentYellow.addAnimation("opponentYellow",opponentYellow2Image);
  ...
  gameState=END;
  racer.changeAnimation("racer",racerImage2);    
opponentRed.changeAnimation("opponentRed",opponentRed2Image);
...
function pinkCyclists(){
  ...
  opponentPink.velocityX=-(6+2*distance/50);
...
function yellowCyclists(){
  ...
  opponentYellow.velocityX=-(6+2*distance/50);
...
function redCyclists(){
  ...
  opponentRed.velocityX=-(6+2*distance/50) ;
